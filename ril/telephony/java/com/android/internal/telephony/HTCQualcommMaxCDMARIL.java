...
public class HTCQualcommMaxCDMARIL extends RIL implements CommandsInterface {

    static final int RIL_UNSOL_ENTER_LPM_MAX = 3023;
    static final int RIL_UNSOL_CDMA_3G_INDICATOR_MAX = 4259;
    static final int RIL_UNSOL_CDMA_ENHANCE_ROAMING_INDICATOR_MAX = 4262;
    static final int RIL_UNSOL_CDMA_NETWORK_BASE_PLUSCODE_DIAL_MAX = 4270;
    static final int RIL_UNSOL_RESPONSE_PHONE_MODE_CHANGE_MAX = 4802;
    static final int RIL_UNSOL_RESPONSE_IMS_NETWORK_STATE_CHANGED_HTC_MAX = 5755;
    static final int RIL_UNSOL_RESPONSE_DATA_NETWORK_STATE_CHANGED_MAX = 5757;
    private boolean isGSM = false;
  
    protected int mQANElements = 5;

    public HTCQualcommMaxCDMARIL(Context context, int networkMode, int cdmaSubscription) {
    ...
    processUnsolicited(Parcel p, int type) {
        ...
        switch (response) {
            case RIL_UNSOL_ENTER_LPM_MAX: ret = responseVoid(p); break;
            case RIL_UNSOL_CDMA_3G_INDICATOR_MAX: ret = responseInts(p); break;
            case RIL_UNSOL_CDMA_ENHANCE_ROAMING_INDICATOR_MAX: ret = responseInts(p); break;
            case RIL_UNSOL_CDMA_NETWORK_BASE_PLUSCODE_DIAL_MAX: ret = responseStrings(p); break;
            case RIL_UNSOL_RESPONSE_PHONE_MODE_CHANGE_MAX: ret = responseInts(p); break;
            case RIL_UNSOL_RESPONSE_IMS_NETWORK_STATE_CHANGED_HTC_MAX: ret = responseVoid(p); break;
            case RIL_UNSOL_RESPONSE_DATA_NETWORK_STATE_CHANGED_MAX: ret = responseInts(p); break;
